...
from decision_transformer.art import AutonomousFreeflyerTransformer, AutonomousFreeflyerTransformer2
...
def get_DT_model(model_name, train_loader, eval_loader):
    ...
    elif 'GSA' in model_name or 'sag' in model_name:
    ...
    # accelerator.load_state(root_folder + '/decision_transformer/saved_files/checkpointsART/' + model_name)    # GSA MODEL
    accelerator.load_state(root_folder + '/decision_transformer/saved_files/checkpoints/' + model_name)    # RCGSA MODEL 
