...
# import decision_transformer.manageflash as DT_manager # use this for flash attention inference
import decision_transformer.manage as DT_manager # # use this for previosu version of inference
import time
...
To use flash attention, uncomment the following line:
    import decision_transformer.manageflash as DT_manager
...
transformer_model_name =  'checkpoint_ff_ctgrtg_art'  # 'checkpoint_ff_ctgrtg_art'; 'checkpoint_ff_flash_art_retrain' ; 'checkpoint_ff_ctgrtg_art' ; 'checkpoint_rtn_v11'; 'checkpoint_rtn_v01'
# transformer_model_name =  'checkpoint_ff_noflash_art_retrain' # 'checkpoint_ff_flash_art_retrain'  # flash model
# transformer_model_name = 'checkpoint_ff_sag' #(g,s,a) model
...
idx = 595 #22260 # index of the test trajectory 19030, 11787, 5514->infeasible in cvxMPC at 4 timestep 32172
